...
(
 "id"                serial NOT NULL,
 nome              varchar(50) NOT NULL,
 fk_id_redesocial  serial NOT NULL,
 fk_id_tipo_ajuda  serial NOT NULL,
 fk_id_endereco    serial NOT NULL,
 ...
 CONSTRAINT FK_3 FOREIGN KEY ( fk_id_endereco ) REFERENCES Endereco ( "id" ),
 CONSTRAINT FK_4 FOREIGN KEY ( fk_id_tipo_ajuda ) REFERENCES tipo_ajuda ( "id" ),
 CONSTRAINT FK_5 FOREIGN KEY ( fk_id_redesocial ) REFERENCES redes_sociais ( "id" )
);
...
CREATE INDEX FK_4 ON ongs
(
 fk_id_tipo_ajuda
);

CREATE INDEX FK_5 ON ongs
(
 fk_id_redesocial
);
...
(
 ...
 CONSTRAINT FK_6 FOREIGN KEY ( fk_id_endereco ) REFERENCES Endereco ( "id" ),
 CONSTRAINT FK_7 FOREIGN KEY ( fk_id_redesocial ) REFERENCES redes_sociais ( "id" ),
 CONSTRAINT FK_8 FOREIGN KEY ( fk_id_usuario ) REFERENCES usuario ( "id" )
);

CREATE INDEX FK_6 ON adotantes
(
 fk_id_endereco
);

CREATE INDEX FK_7 ON adotantes
(
 fk_id_redesocial
);

CREATE INDEX FK_8 ON adotantes
(
 fk_id_usuario
);
...
(
 ...
 CONSTRAINT FK_9 FOREIGN KEY ( fk_id_ongs ) REFERENCES ongs ( "id" ),
 CONSTRAINT FK_10 FOREIGN KEY ( fk_id_especie_de_pets ) REFERENCES especie_de_pets ( "id" )
);

CREATE INDEX FK_9 ON pets
(
 fk_id_ongs
);
...
(
 ...
 CONSTRAINT FK_11 FOREIGN KEY ( fk_id_pet ) REFERENCES pets ( "id" ),
 CONSTRAINT FK_12 FOREIGN KEY ( fk_id_adotantes ) REFERENCES adotantes ( "id" )
);

CREATE INDEX FK_11 ON adocao
(
 fk_id_pet
);
